...
<html lang="fa-ir" dir="rtl">
    <head>
        ...
        <title>واحد کنترل | پنل مدیریتی فروشگاه اینترنتی داریمش</title>
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="assets/images/admin2.jpg" alt="user-img" title="Mat Helme" class="img-circle img-thumbnail img-responsive">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="post-tab.php" class="waves-effect "><i class="fa fa-tags"></i> <span> مدیریت پست ها </span> </a>
                            </li>
